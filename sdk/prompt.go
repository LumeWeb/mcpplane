...
// Prompt converts a host-owned prompt descriptor into an official SDK
// prompt.
...
// messageContent converts a host-owned prompt message into official SDK
...
// promptHandler adapts a host-owned prompt handler to the official SDK

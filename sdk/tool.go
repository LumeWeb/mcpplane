...
// Tool converts a host-owned tool descriptor into an official SDK tool. The
...
func Tool(desc model.ToolDescriptor) *mcp.Tool {
	// OpenAI per-tool auth declaration. The reference deployment's whole MCP
	// server sits behind a

// Package sdk is the ONLY package under go.lumeweb.com/mcpplane that imports
// github.com/modelcontextprotocol/go-sdk/mcp. It bridges the library's SDK-neutral
// descriptors (defined in the model package) onto an official MCP SDK
...
//
// The rest of mcpplane (model, session, toolargs, ieo, transport) stays SDK-free:
// they speak host-owned descriptors and handlers; this package is the bridge
...
// Implementation returns the server implementation descriptor used to
...
// serverOptions maps mcpplane options onto the official SDK. mcpplane ships MCP
...
// NewServer builds an official-SDK MCP server pre-configured with the
// library's default identity (Name "pinner") and UI capability advertisement.
// Feature registration is performed separately with the Register*
// functions in this package. Embedding applications that need their own
// serverInfo name should construct mcp.Server via mcp.NewServer directly or
// wrap this call.

...
//
// The values are SDK-neutral. They replace an earlier CLI-specific
// vocabulary; the original mapping was:
//
//	"vault"  -> CategoryStorage ("storage")
//	"ipns"   -> CategoryNames   ("names")
//	"admin"  -> CategoryAdmin   ("admin", kept as-is)
//
// Consumer packages register tools with the neutral values above.
...
const (
	...
	CategoryNames      ToolCategory = "names"
...
type ToolEntry struct {
	...
	// custom transport tools whose agent-facing description varies by host
	// environment.
